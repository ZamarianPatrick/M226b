...
/**
 * <p>Verwertet eine Spieloptionen Nachricht, welche vom Client als Nachricht gesendet
 * wird</p>
 * 
 * @author Patrick
 * @version 1.0
...
public class GameOptionPacket extends Packet{
	 ...
	 * Erzeugt ein GameOptionPacket
	 * 
	 * @param game Spiel, von welchem ein GameOptionPacket erzeugt werden soll
	 */
	
	public GameOptionPacket(Game game) {
		this.defaultPlayerAmount = game.getDefaultPlayerAmount();
		this.avaiblePlayerAmounts = game.getAvaiblePlayerAmounts();
		this.options = game.getGameOptions();
	}
